                      ...
                      {season.episodes.map((episode, episodeIndex) => (
                          editingEpisode && editingEpisode.seasonIndex === seasonIndex && editingEpisode.episodeIndex === episodeIndex ? (
                            <tr key={episodeIndex} className="border-b bg-gray-50">
                              ...
                              <td className="py-2">
                                <input type="url" placeholder="Thumbnail URL" value={editEpisodeData?.thumbnail ?? ''} onChange={e => setEditEpisodeData(d => d ? { ...d, thumbnail: e.target.value } : d)} className="w-24 border rounded p-1 mb-1" />
                                ...
                                <input type="url" placeholder="Master URL 1080p" value={editEpisodeData?.master_url_1080p ?? ''} onChange={e => setEditEpisodeData(d => d ? { ...d, master_url_1080p: e.target.value } : d)} className="w-24 border rounded p-1 mb-1" />
