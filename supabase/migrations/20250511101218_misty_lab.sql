/*
  # Fix Watch History and Continue Watching Feature

  1. Changes
    - Add indexes to improve watch history query performance
    - Add function to get continue watching content
    - Update watch history policies
